    ...
    *,
    ...
    if history:
        ...
        ctx_lines.append(
            ...
            "older than a `prd.md UPDATED` (or legacy `AMENDED`) row, "
            "that verdict was produced under a previous PRD — its "
            "findings may already be addressed by the latest PRD "
            "version — the row's summary names the removed and changed "
            "requirements; findings about a removed requirement are "
            "void; treat them as historical signals to confirm rather "
            "than fresh blockers. (b) if your "
